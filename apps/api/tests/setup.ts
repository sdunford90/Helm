...
export const mockPrisma = {
  ...
  productGlMapping: { findMany: vi.fn().mockResolvedValue([]), findFirst: vi.fn(), upsert: vi.fn(), delete: vi.fn() },
  ...
  dockageRateGlMapping: { findMany: vi.fn().mockResolvedValue([]), findFirst: vi.fn(), upsert: vi.fn(), delete: vi.fn() },
  serviceFee: { findMany: vi.fn().mockResolvedValue([]), findFirst: vi.fn(), create: vi.fn(), update: vi.fn(), count: vi.fn().mockResolvedValue(0) },
  serviceFeeGlMapping: { findMany: vi.fn().mockResolvedValue([]), findFirst: vi.fn(), upsert: vi.fn(), delete: vi.fn() },
