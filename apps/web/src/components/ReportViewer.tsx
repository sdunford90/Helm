...
const s = {
  ...
  kpiValue: { fontSize: '24px', fontWeight: 700, color: '#0A2342', fontFamily: 'Inter, system-ui, sans-serif', fontVariantNumeric: 'tabular-nums' },
  ...
  tdRight: { padding: '10px 16px', color: '#0A2342', borderBottom: '1px solid #F1F5F9', textAlign: 'right' as const, fontFamily: 'Inter, system-ui, sans-serif', fontVariantNumeric: 'tabular-nums', verticalAlign: 'middle' as const },
