...
const styles: Record<string, React.CSSProperties> = {
  ...
  statValue: { fontSize: 24, fontWeight: 700, color: NAVY, fontFamily: 'Inter, system-ui, sans-serif', fontVariantNumeric: 'tabular-nums' },
  ...
  tdMono: { padding: '12px 16px', borderBottom: '1px solid #F1F5F9', color: NAVY, fontFamily: 'Inter, system-ui, sans-serif', fontVariantNumeric: 'tabular-nums', textAlign: 'right' as const },
